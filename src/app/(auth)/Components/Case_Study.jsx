...
export default function Case_Study() {
  ...
  return (
    <div className=" ">
      ...
      <Link href={"/Case_Study_Form"}><button className="text-white flex text-xl bg-green-400 rounded-md p-4  mx-4 ">
        <FaPlus className="mx-2 text-3xl" />
        Add New Case Study
      </button>
      </Link>

      <h1 className="mx-4 text-xl py-4">Case Study List</h1>
        ...
        <table className=" w-full">
          <thead className=" bg-gray-300">
            <tr className="">
              ...
              <td className="px-2 border-2">Thumbs</td>
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-md">
            ...
            <p>Please confirm you would like to delete this Case Study.</p>
