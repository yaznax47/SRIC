...
export default function Section_admin() {
  ...
  return (
    <div className=" ">
      ...
      <h1 className="mx-4 text-xl py-4">Section List</h1>
        ...
        <table className=" w-full">
          <thead className=" bg-gray-300">
            <tr className="">
              ...
              <td className="px-2 border-2">Sub-Title</td>
              <td className="px-2 border-2">Description</td>
              <td className="px-2 border-2">Section Type</td>
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-md">
            ...
            <p>Please confirm you would like to delete this Section.</p>
